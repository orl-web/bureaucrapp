...
async function crawl() {
  const url = 'https://www.agenziaentrate.gov.it/portale/codice-fiscale-e-tessera-sanitaria';
  ...
  try {
    ...
    // Extract all links matching "/portale/codice-fiscale-e-tessera-sanitaria"
    const regex = /href="([^"]+)"/g;
    let match;
    const links = new Set();
