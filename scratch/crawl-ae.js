...
async function crawl() {
  const url = 'https://www.agenziaentrate.gov.it/portale/schede/istanze';
  console.log(`Fetching ${url} to extract links...`);
  ...
  try {
    ...
    // Extract all links matching "/portale/schede/istanze/" or related
    const regex = /href="([^"]+)"/g;
    let match;
    const links = new Set();
